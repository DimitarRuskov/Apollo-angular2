...
@RouteConfig([
    ...
    {path: '/categories/:category/routines',      name: 'Routines',       component: ListRoutinesComponent},
    {path: '/categories/:category/routines/add',  name: 'AddRoutine',     component: AddRoutineComponent},
    {path: '/categories/:category/routines/:routine',  name: 'DetailsRoutine',     component: DetailsRoutineComponent},
